...
PM_START = """Hai {} ! My name is Alvin - I'm here to help you manage your groups!

Click Help button to find out more about how to use me to my full potential.

Join My Channel [Liu Alvinas](http://t.me/liualvinasmahaputra) 

My Instagram [LiuAlvinas_](instagram.com/liualvinas_) 

Want to add me to your group? Click here! [Click Here](http://t.me/AlvinGroupBot?startgroup=true)
"""
...
def start(bot: Bot, update: Update, args: List[str]):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Ahh Mantap 
         ")
